...
const namespace = "plant-safety-observation-log";
const modules = [
  {
    "id": "observations",
    "label": "Observations"
  ...
  "history": [
    {
      "historyId": "HS-22",
      "obsId": "OBS-700",
      "event": "Record locked by another user",
      "eventOn": "2012-02-10 10:22",
      "status": "Logged"
    }
  ]
}));
...
function render() {
  ...
  const contentHtml =
    panel("Safety observations, corrective action routing, supervisor verification, and closeout history.", grid) +
