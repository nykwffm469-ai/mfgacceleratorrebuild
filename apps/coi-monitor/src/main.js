...
ensureSeed(namespace, () => ({
  "certificates": [
    {
      "certificateId": "COI-771",
      "vendor": "Skyline Electric",
      "expiryDate": "2011-12-01",
      "coverage": "2M GL",
      "status": "Expiring"
    }
  ],
  ...
  "exceptions": [
    {
      "exceptionId": "EX-COI-1",
      "vendor": "Skyline Electric",
      "exceptionType": "Grace period",
      "approver": "Risk VP",
      "status": "Pending"
    }
  ]
...
function render() {
  ...
  const contentHtml =
    panel("Certificate expiry tracking, collection reminders, and vendor compliance locks.", grid) +
