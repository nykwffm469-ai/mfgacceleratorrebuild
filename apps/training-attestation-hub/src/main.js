...
const namespace = "training-attestation-hub";
const modules = [
  {
    "id": "learners",
    "label": "Learners"
  ...
  "completions": [
    {
      ...
      "learnerId": "LR-118",
      "course": "SOX Basics",
      "completedOn": "2010-02-04",
      "status": "Recorded"
    }
  ],
  "attestations": [
    {
      "attestationId": "AT-200",
      "learnerId": "LR-118",
      "period": "2010-Q1",
      "result": "Pending",
      "status": "Open"
...
function render() {
  ...
  const contentHtml =
    panel("Training completion attestations, overdue reminders, and exception approvals.", grid) +
